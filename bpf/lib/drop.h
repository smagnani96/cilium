...
#define send_drop_notify_error_flags(ctx, src, reason, direction, flags) \
	_send_drop_notify(__MAGIC_FILE__, __MAGIC_LINE__, ctx, src, 0, 0, \
			  __DROP_REASON_EXT_FLAGS(reason, 0, flags), CTX_ACT_DROP, direction)
...
#define send_drop_notify_error_ext_flags(ctx, src, reason, ext_err, direction, flags) \
	_send_drop_notify(__MAGIC_FILE__, __MAGIC_LINE__, ctx, src, 0, 0, \
			  __DROP_REASON_EXT_FLAGS(reason, ext_err, flags), CTX_ACT_DROP, direction)
...
#define send_drop_notify_error_with_exitcode_ext_flags(ctx, src, reason, ext_err, exitcode, \
			  direction, flags) \
	_send_drop_notify(__MAGIC_FILE__, __MAGIC_LINE__, ctx, src, 0, 0, \
			  __DROP_REASON_EXT_FLAGS(reason, ext_err, flags), exitcode, direction)
