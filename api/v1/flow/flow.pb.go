...
const (
	EncryptionType_ENCRYPTION_UNKNOWN EncryptionType = 0
	EncryptionType_WIREGUARD          EncryptionType = 1
	EncryptionType_IPSEC              EncryptionType = 2
)
...
type Flow struct {
	...
	Encap       *Encapsulation `protobuf:"bytes,39,opt,name=encap,proto3" json:"encap,omitempty"`
...
func (x *Flow) GetEncap() *Encapsulation {
	if x != nil {
		return x.Encap
	}
	return nil
...
type IP struct {
	...
	EncryptionProtocol EncryptionType `protobuf:"varint,4,opt,name=encryptionProtocol,proto3,enum=flow.EncryptionType" json:"encryptionProtocol,omitempty"`
	Encrypted          bool           `protobuf:"varint,6,opt,name=encrypted,proto3" json:"encrypted,omitempty"`
	Decrypted          bool           `protobuf:"varint,7,opt,name=decrypted,proto3" json:"decrypted,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *IP) GetEncryptionProtocol() EncryptionType {
	if x != nil {
		return x.EncryptionProtocol
	}
	return EncryptionType_ENCRYPTION_UNKNOWN
}
...
const file_flow_flow_proto_rawDesc = "" +
	"\n" +
	"\x0fflow/flow.proto\x12\x04flow\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x98\x0f\n" +
	"\x04Flow\x12.\n" +
	...
	"\x05encap\x18' \x01(\v2\x13.flow.EncapsulationR\x05encap\x12&\n" +
	...
	"\x05flags\x18\x03 \x01(\v2\x0e.flow.TCPFlagsR\x05flags\"\x94\x02\n" +
	"\x02IP\x12\x16\n" +
	"\x06source\x18\x01 \x01(\tR\x06source\x12#\n" +
	"\rsource_xlated\x18\x05 \x01(\tR\fsourceXlated\x12 \n" +
	"\vdestination\x18\x02 \x01(\tR\vdestination\x12-\n" +
	"\tipVersion\x18\x03 \x01(\x0e2\x0f.flow.IPVersionR\tipVersion\x12D\n" +
	"\x12encryptionProtocol\x18\x04 \x01(\x0e2\x14.flow.EncryptionTypeR\x12encryptionProtocol\x12\x1c\n" +
	"\tencrypted\x18\x06 \x01(\bR\tencrypted\x12\x1c\n" +
	"\tdecrypted\x18\a \x01(\bR\tdecrypted\"D\n" +
	"\bEthernet\x12\x16\n" +
	"\x06source\x18\x01 \x01(\tR\x06source\x12 \n" +
...
var file_flow_flow_proto_goTypes = []any{
	...
	(EncryptionType)(0),                   // 5: flow.EncryptionType
	...
	(Encapsulation_Protocol)(0),           // 16: flow.Encapsulation.Protocol
	...
	(*Encapsulation)(nil),                 // 33: flow.Encapsulation
...
var file_flow_flow_proto_depIdxs = []int32{
	...
	7,  // 1: flow.Flow.verdict:type_name -> flow.Verdict
	1,  // 2: flow.Flow.auth_type:type_name -> flow.AuthType
	27, // 3: flow.Flow.ethernet:type_name -> flow.Ethernet
	26, // 4: flow.Flow.IP:type_name -> flow.IP
	19, // 5: flow.Flow.l4:type_name -> flow.Layer4
	33, // 6: flow.Flow.encap:type_name -> flow.Encapsulation
	23, // 7: flow.Flow.source:type_name -> flow.Endpoint
	23, // 8: flow.Flow.destination:type_name -> flow.Endpoint
	0,  // 9: flow.Flow.Type:type_name -> flow.FlowType
	20, // 10: flow.Flow.l7:type_name -> flow.Layer7
	36, // 11: flow.Flow.event_type:type_name -> flow.CiliumEventType
	42, // 12: flow.Flow.source_service:type_name -> flow.Service
	42, // 13: flow.Flow.destination_service:type_name -> flow.Service
	9,  // 14: flow.Flow.traffic_direction:type_name -> flow.TrafficDirection
	...
	18, // 17: flow.Flow.file:type_name -> flow.FileInfo
	8,  // 18: flow.Flow.drop_reason_desc:type_name -> flow.DropReason
	58, // 19: flow.Flow.is_reply:type_name -> google.protobuf.BoolValue
	10, // 20: flow.Flow.debug_capture_point:type_name -> flow.DebugCapturePoint
	54, // 21: flow.Flow.interface:type_name -> flow.NetworkInterface
	21, // 22: flow.Flow.trace_context:type_name -> flow.TraceContext
	14, // 23: flow.Flow.sock_xlate_point:type_name -> flow.SocketTranslationPoint
	59, // 24: flow.Flow.extensions:type_name -> google.protobuf.Any
	34, // 25: flow.Flow.egress_allowed_by:type_name -> flow.Policy
	34, // 26: flow.Flow.ingress_allowed_by:type_name -> flow.Policy
	34, // 27: flow.Flow.egress_denied_by:type_name -> flow.Policy
	34, // 28: flow.Flow.ingress_denied_by:type_name -> flow.Policy
	25, // 29: flow.Layer4.TCP:type_name -> flow.TCP
	29, // 30: flow.Layer4.UDP:type_name -> flow.UDP
	31, // 31: flow.Layer4.ICMPv4:type_name -> flow.ICMPv4
	32, // 32: flow.Layer4.ICMPv6:type_name -> flow.ICMPv6
	30, // 33: flow.Layer4.SCTP:type_name -> flow.SCTP
	4,  // 34: flow.Layer7.type:type_name -> flow.L7FlowType
	38, // 35: flow.Layer7.dns:type_name -> flow.DNS
	40, // 36: flow.Layer7.http:type_name -> flow.HTTP
	41, // 37: flow.Layer7.kafka:type_name -> flow.Kafka
	22, // 38: flow.TraceContext.parent:type_name -> flow.TraceParent
	24, // 39: flow.Endpoint.workloads:type_name -> flow.Workload
	28, // 40: flow.TCP.flags:type_name -> flow.TCPFlags
	6,  // 41: flow.IP.ipVersion:type_name -> flow.IPVersion
	5,  // 42: flow.IP.encryptionProtocol:type_name -> flow.EncryptionType
	16, // 43: flow.Encapsulation.protocol:type_name -> flow.Encapsulation.Protocol
	26, // 44: flow.Encapsulation.IP:type_name -> flow.IP
	19, // 45: flow.Encapsulation.l4:type_name -> flow.Layer4
	24, // 46: flow.FlowFilter.source_workload:type_name -> flow.Workload
	24, // 47: flow.FlowFilter.destination_workload:type_name -> flow.Workload
	9,  // 48: flow.FlowFilter.traffic_direction:type_name -> flow.TrafficDirection
	7,  // 49: flow.FlowFilter.verdict:type_name -> flow.Verdict
	8,  // 50: flow.FlowFilter.drop_reason_desc:type_name -> flow.DropReason
	54, // 51: flow.FlowFilter.interface:type_name -> flow.NetworkInterface
	35, // 52: flow.FlowFilter.event_type:type_name -> flow.EventTypeFilter
	39, // 53: flow.FlowFilter.http_header:type_name -> flow.HTTPHeader
	28, // 54: flow.FlowFilter.tcp_flags:type_name -> flow.TCPFlags
	6,  // 55: flow.FlowFilter.ip_version:type_name -> flow.IPVersion
	56, // 56: flow.FlowFilter.experimental:type_name -> flow.FlowFilter.Experimental
	39, // 57: flow.HTTP.headers:type_name -> flow.HTTPHeader
	12, // 58: flow.LostEvent.source:type_name -> flow.LostEventSource
	60, // 59: flow.LostEvent.cpu:type_name -> google.protobuf.Int32Value
	13, // 60: flow.AgentEvent.type:type_name -> flow.AgentEventType
	...
	15, // 73: flow.DebugEvent.type:type_name -> flow.DebugEventType
	23, // 74: flow.DebugEvent.source:type_name -> flow.Endpoint
