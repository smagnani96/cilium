...
const (
	...
	Observer_GetConntrackEntries_FullMethodName = "/observer.Observer/GetConntrackEntries"
)
...
type ObserverClient interface {
	...
	// GetConntrackEntries returns the connection tracking entries currently
	...
	GetConntrackEntries(ctx context.Context, in *GetConntrackEntriesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetConntrackEntriesResponse], error)
}
...
func (c *observerClient) GetConntrackEntries(ctx context.Context, in *GetConntrackEntriesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetConntrackEntriesResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Observer_ServiceDesc.Streams[3], Observer_GetConntrackEntries_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetConntrackEntriesRequest, GetConntrackEntriesResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Observer_GetConntrackEntriesClient = grpc.ServerStreamingClient[GetConntrackEntriesResponse]
...
type ObserverServer interface {
	...
	// maps are LRU-based, the result is a best-effort snapshot: entries may
	// be evicted or added while it is being produced.
	GetConntrackEntries(*GetConntrackEntriesRequest, grpc.ServerStreamingServer[GetConntrackEntriesResponse]) error
}
...
func (UnimplementedObserverServer) GetConntrackEntries(*GetConntrackEntriesRequest, grpc.ServerStreamingServer[GetConntrackEntriesResponse]) error {
	return status.Error(codes.Unimplemented, "method GetConntrackEntries not implemented")
}
...
func _Observer_GetConntrackEntries_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetConntrackEntriesRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ObserverServer).GetConntrackEntries(m, &grpc.GenericServerStream[GetConntrackEntriesRequest, GetConntrackEntriesResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Observer_GetConntrackEntriesServer = grpc.ServerStreamingServer[GetConntrackEntriesResponse]
...
var Observer_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetConntrackEntries",
			Handler:       _Observer_GetConntrackEntries_Handler,
			ServerStreams: true,
		},
	},
