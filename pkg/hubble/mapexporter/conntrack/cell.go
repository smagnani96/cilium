...
var defaultConntrackExporterConfig = Config{
	...
	EnableConntrackEnrichment: false,
...
type Config struct {
	...
	// EnableConntrackEnrichment specifies whether GetConntrackEntries results
	// are enriched with additional info (endpoint, etc.)
	EnableConntrackEnrichment bool `mapstructure:"hubble-enable-conntrack-enrichment"`
...
func (def Config) Flags(flags *pflag.FlagSet) {
	...
	flags.Bool("hubble-enable-conntrack-enrichment", def.EnableConntrackEnrichment, "Enable enrichment of GetConntrackEntries results with additional info (endpoint, etc.).")
